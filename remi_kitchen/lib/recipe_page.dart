...
class _RecipePageState extends State<RecipePage> {
  ...
  late Map<String, double?> adjustedIngredients = Map.fromIterable(ingredients,
      key: (e) => e.ingredient.id, value: (e) => e.quantity);
  late Map<String, bool?> checkboxes = Map.fromIterable(ingredients,
      key: (e) => e.ingredient.id, value: (e) => false);
  late Map<int, bool?> checksteps =
      Map.fromIterable(steps, key: (e) => e.number, value: (e) => false);
